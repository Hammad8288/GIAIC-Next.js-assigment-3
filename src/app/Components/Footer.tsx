            ...
            <div className="w-[1480px] h-[289px] gap-[100px]">
                <div className="w-[1480px] h-[169px] gap-[100px] flex justify-center">
                    ...
                    <div className="w-[295px] h-[130px] gap-[16px]">
                        ...
                        <p className="w-[140px] h-[20px] text-[16px] leading-[20px] font-[400] mt-5">Guides & tutorials</p>
                        <p className="w-[130px] h-[20px] text-[16px] leading-[20px] font-[400] mt-5">Help center</p>
                    </div>
                    <div className="w-[295px] h-[130px] gap-[16px]">
                        <p className="font-bold w-[83px] h-[22px] text-[18px] leading-[21.78px]">Company</p>
                        <p className="w-[70px] h-[20px] text-[16px] leading-[20px] font-[400] mt-5">About us</p>
                ...
                <div className="w-[1480px] h-[20px] mt-20 flex justify-center items-center">
                    <div className="w-[169px] h-[20px] gap-[60px]">
                        <p className="w-[180px] h-[20px] font-[400] text-[16px] leading-[20px]">©2021 Whitepace LLC.</p>
                    </div>
                </div>
            </div>
        </div>
